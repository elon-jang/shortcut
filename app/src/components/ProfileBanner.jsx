...
export const ProfileBanner = ({ levelProgress, userData, isTodayComplete, masteryStats }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-50 via-white to-slate-50 dark:from-indigo-900/30 dark:via-slate-800/80 dark:to-slate-900/80 border border-indigo-200 dark:border-indigo-500/15 rounded-2xl p-4 md:p-5 mb-5 flex items-center justify-between gap-4 shadow-lg">
      <div className="flex items-center gap-4">
        <div className="relative shrink-0">
          <div className="w-12 h-12 bg-slate-100 dark:bg-slate-900 rounded-xl flex items-center justify-center border border-indigo-300 dark:border-indigo-500/20">
            <ShieldCheck size={24} className="text-indigo-400" />
          </div>
          <div className="absolute -bottom-1.5 -right-1.5 bg-gradient-to-r from-yellow-400 to-orange-500 text-slate-900 text-[9px] font-black px-1.5 py-0.5 rounded-md border border-slate-200 dark:border-slate-800">
        ...
        <div className="min-w-0">
          ...
          <div className="w-40 md:w-52 h-1.5 bg-slate-200 dark:bg-slate-900 rounded-full overflow-hidden mt-1.5 border border-slate-300 dark:border-slate-700/50">
            <div
              className="h-full bg-gradient-to-r from-indigo-500 to-purple-500 transition-all duration-1000 ease-out"
              style={{ width: `${levelProgress.xpInLevel}%` }}
            />
          </div>
          <p className="text-[9px] md:text-[11px] text-slate-500 dark:text-slate-600 mt-1 font-medium">
